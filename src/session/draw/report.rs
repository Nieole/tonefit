...
"│ 记号  页名     尺寸       判定  理由                      判据                                                                       │"
"│ *     003.jpg  1182x1680  4bit  阈值内最低的一档          1bit+FS 32.000 ⋅ 2bit 20.000 ⋅ 4bit 8.000 ⋅ 8bit 2.000  定档页             │"
"│ !     004.jpg  1600x1680  8bit  特例页单独定档            1bit+FS 32.000 ⋅ 2bit 20.000 ⋅ 4bit 8.000 ⋅ 8bit 2.000  特例页  宽溢出     │"
"│ !     005.jpg  1182x1680  4bit  几何门不成立，本页不抖动  1bit+FS 32.000 ⋅ 2bit 20.000 ⋅ 4bit 8.000 ⋅ 8bit 2.000  几何门不成立       │"
"│ !     006.jpg  1182x1680  4bit  卷级上包络                1bit+FS 32.000 ⋅ 2bit 20.000 ⋅ 4bit 8.000 ⋅ 8bit 2.000  兜底上界           │"
"│ !     007.jpg  1182x1680  4bit  卷级上包络                1bit+FS 32.000 ⋅ 2bit 20.000 ⋅ 4bit 8.000 ⋅ 8bit 2.000  救回 62.0%         │"
"│ ✗     017.jpg  1182x1680                                                                                          失败 解不出完整尺  │"
"│ 寸：JPEG 数据截断                                                                                                                    │"
"│                                                                                                                                      │"
"└──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘"
...
"│ 记号  页名     尺寸       判定  理由                      判据                                                                       ▲"
"│ ✓     001.jpg  1182x1680  4bit  卷级上包络                1bit+FS 32.000 ⋅ 2bit 20.000 ⋅ 4bit 8.000 ⋅ 8bit 2.000                     █"
"│ ✓     002.jpg  1182x1680                                                                                          彩页 · 彩色分支：只█"
...
"│ ✗     017.jpg  1182x1680                                      失败 解不出完整尺寸：JPEG 数据截断                     │"
"│                                                                                                                      │"
"│                                                                                                                      │"
"│                                                                                                                      │"
"│                                                                                                                      │"
