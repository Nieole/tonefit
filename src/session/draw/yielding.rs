...
mod tests {
    ...
    /// 十八行的屏留给左栏十三行，而三层一共二十二行。`▲`／`▼` 两头加中间那一截滑块
...
"│设备层 · 判定的依据，绑面板，改 ▲│ 总体 3000/500⋯ · 已用 5m00s│"
"│一次管很久                      █│ 本卷 卷三 · ⋯ 1000/3000 步 │"
...
"│  跨页拆分　　　　默认（拆）    ▼│                            │"
"└────────────────────────────────┘└────────────────────────────┘"
" ⏎ 空格 摊开取值 · t 试算 · x 执行 · Esc Ctrl-C q 退出 · ? F1 全"
" 部键                                                           "
"                                                                "
"#;
...
"│                                                ▼│                            │"
"└────────────────────────────────────────────────┘└────────────────────────────┘"
" ⏎ 空格 摊开取值 · t 试算 · x 执行 · Esc Ctrl-C q 退出 · ? F1 全部键            "
"                                                                                "
"                                                                                "
"#;
...
"┌配置────────────────────────────────────────────┐┌执行 · 第 3/3 ⋯ 还剩约 3m20s┐"
"│设备层 · 判定的依据，绑面板，改一次管很久       ▲│ 总体 3000/500⋯ · 已用 5m00s│"
...
"│ 记号  页名     尺寸       缩放                       判定  理由              │"
"│ *     001.jpg  1182x1680  缩放比 1.219 ⋅ 未预缩      4bit  阈值内最低的一档  │"
"│ 定档页                                                                       │"
"│ ✗     017.jpg  1182x1680  失败页 ⋅ 卷内统一尺寸留白                          │"
