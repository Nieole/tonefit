...
/// （`mixed`、`archive.cbz`、`damaged`）则只够得着上包络与离群，够不着迟滞。
...
fn mono_cases() -> Vec<Case> {
    vec![
        ...
        // 一个基准档过不了它的界、又够不上离群，成段之后升到 `2bit+FS`。
